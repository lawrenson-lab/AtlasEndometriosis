...
aux.seurat <- readRDS("rds/d10x.seurat.re-integration.cluster.res3.rds")

aux.seurat@meta.data$Major.Class[aux.seurat@meta.data$Major.Class == "Extra-ovarian endometriosis"] = "Endometriosis"
aux.seurat@meta.data$Major.Class[aux.seurat@meta.data$SampleName == "BEME228_A4"] = "Endometriosis"

levels(aux.seurat@meta.data$active.cluster)[1] <- "Mesenchymal cells"
aux.seurat@meta.data$active.cluster[aux.seurat@meta.data$active.cluster == "Fibroblast"] = "Mesenchymal"

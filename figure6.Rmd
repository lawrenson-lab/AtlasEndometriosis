...
``` {r include=T, message=F, eval=T,  warning=F, fig.align='center', fig.width = 8, fig.height=5}
...
prop <- data.frame(table(.sel.sc@meta.data$Major.Class, .sel.sc@meta.data$Menstrual.Cycle))
...
``` {r include=T, warning=F, message=F, fig.align='center', ig.height=12}
